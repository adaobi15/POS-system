...
static{
File file = new File("C:\\Users\\adaobi\\OneDrive\\Documents\\NetBeansProjects\\POSsystem\\src\\cv_folder\\opencv_java249.dll");
...
private final MatOfByte mem = new MatOfByte();
    ...
    public class DaemonThread implements Runnable {
        ...
        private void CaptureImage (JLabel imagepix){
            try{
                stopCam();
                if (getImage != null){
                    ...
                    ImageIcon imageico = new ImageIcon(new ImageIcon (Filename).getImage().getScaledInstance(it_admin.jLabel10.getWidth(), 
                            it_admin.jLabel10.getHeight(), Image.SCALE_DEFAULT));
                    it_admin.jLabel10.setIcon(imageico);
                }
            }catch(Exception e){
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagesandicons/icons8-capture-48.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int option = JOptionPane.showConfirmDialog(rootPane, "Are you sure you want ti capture the image");
        if (option == 0 ){
            try {
               ...
               // it_admin.jTextField6.setText(Filename);
                File imagepic = new File (Filename);
                FileInputStream fis =  new FileInputStream(imagepic);
